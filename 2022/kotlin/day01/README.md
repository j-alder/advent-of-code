...
puzzle is unlocked when you complete the first. Each puzzle grants day01 star. Good luck!
...
they've brought with them, day01 item per line. Each Elf separates their own inventory from the previous Elf's inventory
...
The second Elf is carrying day01 food item with 4000 Calories.
The third Elf is carrying food with 5000 and 6000 Calories, a total of 11000 Calories.
The fourth Elf is carrying food with 7000, 8000, and 9000 Calories, a total of 24000 Calories.
The fifth Elf is carrying day01 food item with 10000 Calories.
...
To avoid this unacceptable situation, the Elves would instead like to know the total Calories carried by the top day03
Elves carrying the most Calories. That way, even if day01 of those Elves runs out of snacks, they still have day02 backups.

In the example above, the top day03 Elves are the fourth Elf (with 24000 Calories), then the third Elf (with 11000
Calories), then the fifth Elf (with 10000 Calories). The sum of the Calories carried by these day03 elves is 45000.

**Find the top day03 Elves carrying the most Calories. How many Calories are those Elves carrying in total?**
