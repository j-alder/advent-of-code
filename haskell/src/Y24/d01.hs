...
input), it quickly becomes clear that the lists aren't very similar. Maybe you can 
...
from the right list, the distance apart is 4; if you pair up a 9 with a 3, the distance 
apart is 6.
