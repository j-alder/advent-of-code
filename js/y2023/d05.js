...
/* 
79 14 55 13
how to convert numbers from source category to destination category
seed-to-soil:
dest range start, source range start, range length
50 98 2 -> 50-51, 98-99 -> seed number 98 corresponds to soil number 50
52 50 48 -> seed number 53 corresponds to soil number 55
* source number is source-dest
*/
...
know that seed number 98 corresponds to soil number 50 and that seed number 
...
you can find its corresponding location number. In this example, the corresponding 
types are:
