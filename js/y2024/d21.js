...
ship's computer reveals that when the missing Historian teleported, he arrived in 
...
button in the bottom right corner. After that, this directional keypad remote 
...
currently experiencing high levels of radiation and nobody can go near it. A robot 
needs to be sent instead.
...
robot, except that this one is typing on a directional keypad instead of a 
numeric keypad).
...
The numeric part of the code (ignoring leading zeroes); for 029A, this would be 
29.
...
Find the fewest number of button presses you'll need to perform in order to cause 
the robot in front of the door to type each code. What is the sum of the 
